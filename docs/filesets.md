...
The top-level `filesets` field of the FINS JSON schema is a dictionary which contains a field for each category of files. Each category in turn has sub-fields for defining the files and their types as described in the table below.
...
| ----------------------------------------------------- | ------- | -------- | --------------------------- | ----------- |
| source                                                | dict[]  | NO       |                             | An array of synthesizable HDL source file definitions. The top-level source filename without the extension **MUST** match the FINS JSON schema `top_source` field. |
...
| sim                                                   | dict[]  | NO       |                             | An array of testbench HDL simulation file definitions. The top-level testbench filename without the extension **MUST** match the FINS JSON schema `top_sim` field. |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+type | string  | NO       | matlab, octave, python, tcl | The language of the pre-simulation script file. If not set, the language is auto-detected based on file extension (".m"=octave, ".py"=python, ".tcl"=tcl). |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+type | string  | NO       | matlab, octave, python, tcl | The language of the post-simulation script file. If not set, the language is auto-detected based on file extension (".m"=octave, ".py"=python, ".tcl"=tcl). |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+type | string  | NO       | matlab, octave, python, tcl | The language of the pre-build script file. If not set, the language is auto-detected based on file extension (".m"=octave, ".py"=python, ".tcl"=tcl). |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+type | string  | NO       | matlab, octave, python, tcl | The language of the post-build script file. If not set, the language is auto-detected based on file extension (".m"=octave, ".py"=python, ".tcl"=tcl). |
