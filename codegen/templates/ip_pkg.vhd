...
-- File:        {{ json_params['params']|selectattr('name', 'equalto', 'IP_PACKAGE')|map(attribute='value')|join('') }}.vhd
...
-- Package
package {{ json_params['params']|selectattr('name', 'equalto', 'IP_PACKAGE')|map(attribute='value')|join('') }} is
...
end {{ json_params['params']|selectattr('name', 'equalto', 'IP_PACKAGE')|map(attribute='value')|join('') }};
