...
class Generator:
    ...
    def create_jinja_env(self, directory):
        ...
        def axi4liteprefix(interface, application_external=False, master=False):
            ...
            Arguments:
                ...
                application_external: should this function return the extended interface name
    ...
    def __setup_gen(self, fins_data, filename, template_dir):
        ...
        Arguments:
            fins_data:    FINS data dictionary
            filename:     name of the 'source' JSON
            template_dir: directory containing Jinja2 templates

        Returns:
            root_dir:   directory containing the 'source' JSON
            output_dir: the code-generation output directory (e.g. 'gen/core')
            jinja_env:  the Jinja2 environment to be used by code-gen
        """
